...
> ⚠️ **v0.2-alpha 浏览器 agent 在 `spike/v0.2-alpha` 分支** · 高风险 · 必须用户在场监控 · 用户真账户 · 不保证 SLA · 勿生产用。
> 详见 [spike/v0.2-alpha branch](https://github.com/suxuemi/laifaxin-skill/tree/spike/v0.2-alpha)
